...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-slate-950/40 via-slate-950/60 to-slate-950/80 -z-10" />
      ...
      >
        ...
        >
          ...
          Industry-leading tolerances and premium quality guaranteed.
        </motion.p>
